...
{
	/// <summary>
	/// Summary description for StkAllocationStatus.
	/// </summary>
	public class StkAllocationStatus : System.Web.UI.Page
	{
...
/*
		private void populateProducts()
		{
			...
			System.Data.DataSet dsTitle = dal.Products_DS();
		...
		public DataSet Products_DS()
		{
			...
			try
			{
				...
				OleDbDataAdapter dbAdapter = new OleDbDataAdapter("select * from pvsupmast", dbConnection);
