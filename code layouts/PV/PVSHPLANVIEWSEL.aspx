<%@ Page language="c#" Codebehind="PVSHPLANVIEWSEL.aspx.cs" AutoEventWireup="false" Inherits="PVMODX.PVSHPLANVIEWSEL" %>
<%@ Register TagPrefix="cr" Namespace="CrystalDecisions.Web" Assembly="CrystalDecisions.Web, Version=9.1.5000.0, Culture=neutral, PublicKeyToken=692fbea5521e1304" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>PVSHPLANVIEWSEL</title>
	</HEAD>
	<BODY>
		<h2 class="h2head">Selected&nbsp;Shipping PLan&nbsp;Records</h2>
		...
		<form id="Form1" method="post" runat="server">
			<asp:panel id="pnlResult" runat="server" Visible="False">
				<TABLE class="sofT" align="center"  >
					<TR>
						<TD class="helphed">Selected&nbsp;Shipping Plan&nbsp;Records
						</TD>
					</TR>
					<TR>
						<TD class="innertitle">The selected&nbsp;Shipping Plan&nbsp;Records&nbsp;are 
							deleted</TD>
					</TR>
				</TABLE>
			</asp:panel>
			
			<asp:panel id="pnlCrystal"  HorizontalAlign =Center  runat="server">
			
				<TABLE id="Table1" width="300" align="center" border="1">
					<TR>
						<TD>
