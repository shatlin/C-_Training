<%@ Page language="c#" Codebehind="PVASNUPL.aspx.cs" AutoEventWireup="false" Inherits="PVMODX.PVASNUPL" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
  <HEAD>
		<title>ASN File upload</title>
	...
	<BODY>
		<H2 class="h2head">Upload Excel ASN</H2>
		
		<form id="Form1" runat="server">
			<TABLE class="sofT" align="center" border="0" height="80">
				<TR>
					<TD class="helpHed" colSpan="3" height="9">Select The Excel ASN file</TD>
				</TR>
				<TR>
...
<TABLE class=sofT width=800 align=center>
  ...
  <TR>
    <TD>
<asp:datagrid id=Datagrid2 runat="server" CssClass="FormDataGrids" Visible="True" Height="23px" BorderColor="Gray" BorderStyle="None" BorderWidth="1px" BackColor="White" CellPadding="3" GridLines="Horizontal" width="800" ShowHeader="False">
