...
namespace PV {
    ...
    public class rptNISList : ReportClass {
    ...
    public class CachedrptNISList : Component, ICachedReport {
        
        public CachedrptNISList() {
        }
