<%@ Page language="c#" Codebehind="PVOTPRDORD.aspx.cs" AutoEventWireup="false" Inherits="PVMODX.PVOTPRDORD" %>
...
<HTML>
	...
	<body>
		<H2 class="h2head">Order tracking by Order Number</H2>
		<FORM name="frmLogin" action="PVOTPRD02.aspx" method="post" runat="server" ID="Form1">
			<TABLE class="sofT" align="center" border="0" height="81" width="300">
				<TR>
					<TD class="helpHed" colSpan="3">Select the Order</TD>
				</TR>
				<TR>
					<TD class="borderlesstitle" colSpan="3">&nbsp;</TD>
				</TR>
				<TR>
					<TD class="borderlesstitle" height="10">Order</TD>
					<TD class="borderlesstitle" width="10" bgColor="#99ccff" height="10">
						<mbcbb:combobox id="cboOrders" runat="server" CssClass="FormComboBoxes" Width="250px" Visible="True"></mbcbb:combobox></TD>
					<TD class="borderlesstitle" width="10" height="10"></TD>
				</TR>
				<TR>
			...
			<asp:Panel ID="pnlPrdDetl" runat="server" Visible="False" Width="100%">
				<TABLE class="sofT" id="detailtables" cellSpacing="0" cellPadding="0" width="100%" align="center"
					border="0">
					<TR>
						<TD class="helpHed" colSpan="3" height="17">Product Details of the Order</TD>
					</TR>
					<TR>
						<TD>
