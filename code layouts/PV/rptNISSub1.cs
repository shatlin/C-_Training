...
namespace PV {
    ...
    public class rptNISSub : ReportClass {
    ...
    public class CachedrptNISSub : Component, ICachedReport {
        
        public CachedrptNISSub() {
        }
