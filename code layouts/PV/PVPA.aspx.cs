...
{
	/// <summary>
	/// This class is used for Purchase Analysis.
	/// </summary>
	public class PVPA : System.Web.UI.Page
	{
		...
		protected System.Web.UI.WebControls.RadioButtonList rdoAnalyseBy;
		...
		//protected System.Web.UI.WebControls.Button btnPrdSelectAll;
		...
		{   
			...
			this.rdoAnalyseBy .SelectedIndexChanged +=new  System.EventHandler(this.rdoAnalyseBy_SelectedIndexChanged );
			...
			//this.btnPrdSelectAll .Click +=new System.EventHandler(this.btnPrdSelectAll_Click);
		...
		protected void SavePA(object sender, System.EventArgs e)
		{
			...
			*/
			...
			string rdoAnalyseValue=rdoAnalyseBy.SelectedValue;
			...
			else
			{
				...
				else
				{
					...
					dal.updateAutoNo(poplanno,"POPLANNO");
					dal.commitTrans ();
				}
			}
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void rdoAnalyseBy_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			showChoice();
		}
		...
		public void showChoice()
		{
			...
			string analysis=rdoAnalyseBy.SelectedValue;
		...
		/// <summary>
		/// binds all external suppliers with a datagrid.This datagrid also
		/// containts a checkbox for each row.user can select or unselect suppiers for
		/// analysis.
		/// </summary>
