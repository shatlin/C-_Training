...
<%@ Page language="c#" Codebehind="PVOTDESC.aspx.cs" AutoEventWireup="false" Inherits="PVMODX.PVOTDESC" %>
...
<HTML>
	...
	<body>
		<H2 class="h2head">Order tracking by product description</H2>
		<center>
			<FORM name="frmLogin" action="PVOTPRD02.aspx" method="post" runat="server" ID="Form1">
				<TABLE class="sofT" align="center" border="0" height="79" width="600">
					<TR>
						<TD class="helpHed" colSpan="3">Select the product description</TD>
					</TR>
					<TR>
						<TD class="borderlesstitle" colSpan="3" height="3">&nbsp;</TD>
					</TR>
					<TR>
						<TD class="borderlesstitle" height="1" width="97">description</TD>
						<TD class="borderlesstitle" width="10" bgColor="#99ccff" height="1">
							<mbcbb:combobox id="cboProducts" runat="server" CssClass="FormComboBoxes" Width="454px" Visible="True"
								DataValueField="product"></mbcbb:combobox>
						</TD>
						...
						<TR>
							<TD>
								<asp:datagrid id="DataGrid2" runat="server" Visible="True" Width="100%" CssClass="FormDataGrids"
									BorderColor="Gray" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Horizontal"
									AutoGenerateColumns="False" AllowPaging="false" OnItemDataBound="DataGrid2_ItemDataBound"
									OnEditCommand="DataGrid2_OnEditCommand" BackColor="White" Height="23px">
								...
								<ASP:LABEL id="lblTotal" Width="120px" CSSCLASS="FormLabels" RUNAT="server"></ASP:LABEL></TD>
						</TR>
					</TABLE>
				</asp:Panel>
			</FORM>
