<%@ Page language="c#" Codebehind="PVCOSTUPL.aspx.cs" AutoEventWireup="false" Inherits="PVMODX.PVCOSTUPL" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>COST File upload</title>
	...
	<BODY>
		...
		<H2 class="h2head">Upload Cost File</H2>
		
		<form id="Form1" runat="server">
			<TABLE class="sofT" align="center" border="0" height="80">
				<TR>
					<TD class="helpHed" colSpan="3" height="9">Select Cost file</TD>
				</TR>
				<TR>
