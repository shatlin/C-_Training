...
{
	/// <summary>
	/// contains path for all the folders used to manage files
	/// involved with ASN,shipping plan,cost, and RF
	/// </summary>
...

	{
		...
		public directories()
		{
			//server path.If the main folder is changed just change this line
