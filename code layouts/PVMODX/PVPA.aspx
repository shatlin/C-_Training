<%@ Page language="c#" Codebehind="PVPA.aspx.cs" AutoEventWireup="false" Inherits="PVMODX.PVPA" %>
									...
									<asp:Table id="tblAnalyse" Runat="server" Width="150" CssClass="sofT" style="vertical-align:top; ">
										...
										<asp:TableRow>
											<asp:TableCell cssclass="smallcell" HorizontalAlign="Left">
												<asp:radiobuttonlist AutoPostBack="True" id="rdoAnalyseBy" style="font-weight: bold;font-size: 11px;font-family: Verdana;text-align:left;"
													runat="server">
...
<!..Collecting product records into arrays..>					
				...
				if(stocknum.Length>0)
				{
					...
					string secname	= "sec"+i; //section name (of  div) that id dynamically created
					...
					%>
<!..The first five columns of the main table..>	
						<tr>
...
%>
<!..Drop down list of preferred suppliers to change (sixth cell)>							
