<%@ Page language="c#" Codebehind="Template.aspx.cs" AutoEventWireup="false" Inherits="gShare.Template" %>
								...
								<tbody>
									<tr height="65">
										...
										<td align="right" width="100%">
											<P align="center">&lt;adspace&gt; <a href="click.aspx?refid=10016" target="new"></a>
											</P>
										</td>
									</tr>
								</tbody>
									...
									<tr>
										<td bgcolor="#e9e9eb">&nbsp;
											<table border="0" cellpadding="0" cellspacing="0" height="31" width="100%">
												<tbody>
													<tr>
														<td class="search" align="center" nowrap width="194"></td>
														...
														<td nowrap><!-- ADD THE FOLLOWING CODE WHEREEVER YOU WANT YOUR LANGUAGE OPTIONS TO SHOW-->
															<div align="center"><a href="lang.aspx?lang=german"></a>&nbsp;&nbsp;<a href="lang.aspx?lang=russian"></a>&nbsp;&nbsp;<a href="lang.aspx?lang=english"></a>&nbsp;&nbsp;</div>
															<!-- END ADDITION -->
														</td>
													</tr>
												</tbody>
...
function toggle(link, divId) { var lText = link.innerHTML; var d = getObject(divId);
 if (lText == '+') { link.innerHTML = '&#8211;'; d.style.display = 'block'; }
														...
														<td class="border" align="center" valign="top" width="33%">
															<table border="0" cellpadding="3" cellspacing="1" width="100%">
																<tbody>
																	...
																	<tr>
																		<td colspan="2" class="feat3"><a href="auctiondetails.aspx?id=108697"> &nbsp; </a>
																		</td>
																	</tr>
																	<tr valign="top">
																		<td colspan="2">
																				...
																				<tbody>
																					<tr>
																						<td class="gradient" align="center" height="85" width="85">
																							<a href="auctiondetails.aspx?id=108697"></a>
																						</td>
																						<td valign="top">
																							<table border="0" cellpadding="3" cellspacing="1" width="100%">
																								<tbody>
																					...
																					<tr>
																						<td class="feat3" align="right">-<a href="auctiondetails.aspx?id=108697"></a></td>
																						<td class="feat2"></td>
																					</tr>
																				</tbody>
																			</table>
																		...
																		<td colspan="2">
																			<table border="0" cellpadding="2" cellspacing="1" width="100%">
																				<tbody>
																					<tr>
																						<td class="gradient" align="center" height="85" width="85">
																							<a href="auctiondetails.aspx?id=108678"></a>
																						</td>
																						<td valign="top">
																							<table border="0" cellpadding="3" cellspacing="1" width="100%">
																								<tbody>
																					...
																					<tr>
																						<td class="feat3" align="right">-<a href="auctiondetails.aspx?id=108678"></a></td>
																						<td class="feat2"></td>
																					</tr>
																				</tbody>
																			</table>
																		...
																		<td colspan="2">
																			<table border="0" cellpadding="2" cellspacing="1" width="100%">
																				<tbody>
																					<tr>
																						<td class="gradient" align="center" height="85" width="85">
																							<a href="auctiondetails.aspx?id=108681"></a>
																						</td>
																						<td valign="top">
																							<table border="0" cellpadding="3" cellspacing="1" width="100%">
																								<tbody>
																					...
																					<tr>
																						<td class="feat3" align="right">-<a href="auctiondetails.aspx?id=108681"></a></td>
																						<td class="feat2"></td>
																					</tr>
																				</tbody>
																			</table>
										...
										<td>
											<div><a href="register.aspx"></a></div>
											<table style="FONT-WEIGHT: bold; COLOR: rgb(24,99,189)" bgcolor="#0a57ad" border="0" cellpadding="2"
												cellspacing="1" width="100%">
												<tbody>
													<tr>
														<td align="center" bgcolor="#c7e3ff" width="20%">-</td>
														<td bgcolor="#c7e3ff" width="80%">-</td>
													</tr>
													<tr>
														<td align="center" bgcolor="#c7e3ff" width="20%">-</td>
														<td bgcolor="#c7e3ff" width="80%">&nbsp;-</td>
											...
											<table border="0" cellpadding="3" cellspacing="0" width="100%">
												<tbody>
													...
													<tr>
														...
														<td class="c2 smallfont" width="100%">
														</td>
													</tr>
													<tr class="contentfont">
														<td class="c4">
														</td>
														<td class="c3 smallfont">
														</td>
													</tr>
													<tr>
														<td class="c3"><img src="images/arrow.gif" height="8" hspace="4" width="8"></td>
													...
													<tr class="contentfont">
														...
														<td class="c3 smallfont"><a href="displaynews.aspx?id=22"> </a>
														</td>
													</tr>
													<tr>
														<td class="c3"><img src="images/arrow.gif" height="8" hspace="4" width="8"></td>
														<td class="c2 smallfont" width="100%"><b> &nbsp; </b>
														</td>
													</tr>
													<tr class="contentfont">
														<td class="c4">
							...
							<table border="0" cellpadding="1" cellspacing="2" width="100%">
								<tbody>
									...
									<tr bgcolor="#f1f1f5">
										...
										<td class="footerfont" height="40" width="100%">
											<P align="center">&nbsp;&nbsp;<a href="index.aspx">Home</a> .&nbsp; <a href="register.aspx">
													REGISTER</a> . <a href="login.aspx">LOGIN</a> . <a href="help.aspx">Help</a>&nbsp;<b>|</b>&nbsp;
