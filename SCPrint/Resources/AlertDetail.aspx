<%@ Page Inherits="Microsoft.PerformanceManagement.Scorecards.WebControls.AlertDetailPage, Microsoft.PerformanceManagement.Scorecards.WebControls, Version=2.0.0.0, Culture=Neutral, PublicKeyToken=31BF3856AD364E35" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<bpm:AlertDetailCtrl id="AlertDetailCtrl1" style="Z-INDEX: 101; LEFT: 0px; POSITION: absolute; TOP: 0px"
				runat="server"></bpm:AlertDetailCtrl>
		</form>
	</body>
</HTML>
